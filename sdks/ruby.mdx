...
Request access to the Ruby client by sending the Schematic team a note in Slack or by emailing `support@schematichq.com`.

Once you have been added to the private repo, using bundler add the following line to your project’s `Gemfile`:

```ruby
gem 'schematic', :git => "https://github.com/SchematicHQ/schematic-ruby.git", ref: '0471548b75053daf3ac7ca36e78da93104644281'
```
