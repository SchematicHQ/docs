...
For this step, you’ll need to [connect Stripe](https://app.schematichq.com/settings). Connecting Stripe will allow Schematic to sync subscription data to automatically assign plan membership, as well as fill in traits like revenue at the plan and company levels.
