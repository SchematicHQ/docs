...
<Info>ℹ️ Schematic supports several SDKs. Check them out [here]().</Info>
...
Once you’ve finished creating the feature, click “Add a new rule” and use the available criteria to build targeting rules. In this example, we’re going to use the Company criteria to target [the company we created earlier](https://www.notion.so/Docs-MVP-e9824df9f89b4d52913581bd6db6a01c?pvs=21), “Example Company”. Once you’ve set up the rule, click “Review” at the top of your screen to verify you’d like the rule to be added and “Save” in the modal.
...
Follow the steps in [Creating companies and users](https://www.notion.so/Docs-MVP-e9824df9f89b4d52913581bd6db6a01c?pvs=21) to initialize the Javascript SDK. Once you have, copy and paste the below into your console. 
...
Plans describes plans in your application. Let’s walk through creating a plan and tying it to a Stripe product.
...
2. **Connect your plan to a Stripe product**

For this step, you’ll need to [connect Stripe](). Connecting Stripe will allow Schematic to sync subscription data to automatically assign plan membership, as well as fill in traits like revenue at the plan and company levels.

Once Stripe is connected, navigate to the plan you’ve just created and click “Edit plan”. In the modal, click “Integrate”, and pick the appropriate Stripe product that corresponds to the Schematic plan. Click “Save”.
...
<Info>Schematic supports several SDKs. Check them out [here]().</Info>
...
Navigate to the [Events]() tab to verify your test call has resulted in a new event in your Schematic account.
