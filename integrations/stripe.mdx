...
The initial release supports the use of basic subscription-level data for rule-based targeting. More billing data, e.g. product quantities and billing amounts, will be supported in future releases.