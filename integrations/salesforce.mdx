...
In the dropdown click "New Resource" and name the resource similar to the screenshot below.
...
Add a Screen element after the HTTP Callout action to observe output.
