...
| --- | --- | --- | --- | --- |
| Environment | Account | App | App & API |  |
| Plan | Account | App | App & API |  |
| Feature | Account | App | App & API |  |
| Feature flag | Account | App | App & API |  |
| Flag rule | Environment | App | App & API |  |
| Rule condition | Environment | App | App & API |  |
| API key | Account and Environment | App | App & API | API keys are always environment-specific, but can be accessed in the Application account-wide. |
| Companies | Environment | API | App & API |  |
| Users | Environment | API | App & API |  |
| Events | Environment | API | App & API |  |
| Plan entitlement | Environment | App | App | An association between a feature and a plan |
| Company override | Environment | App | App | An association between a feature and a company |
