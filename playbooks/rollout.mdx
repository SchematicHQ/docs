---
title: Rolling out beta features with flags
description: ""
---
...
Traits can be added to Company profiles using the Company upsert API. Here's an example of adding a `beta` trait to a company:
