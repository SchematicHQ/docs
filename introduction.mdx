...
Licenses are essentially a relationship between a plan in the Product Catalog and a Company Profile. A company may have more than one active license at any given time, which would result in a superset of entitlements among them.
