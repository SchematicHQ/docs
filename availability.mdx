...
As a developer or business implementing Schematic, we understand you are trusting the solution to be highly available and reliable. Given the nature of the transactions that Schematic supports for businesses, we’re committed to both. 
...
Your application uses Schematic SDKs to connect to Schematic and uses that connection to share context about your companies and users, as well as to evaluate flags based on rule-based targeting set up in the application based on anything you specify. Our SDKs are [here](/introduction#sdks).
